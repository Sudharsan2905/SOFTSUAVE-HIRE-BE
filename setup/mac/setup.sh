...
echo "============================================"
echo " Softsuave Hire BE - macOS Setup"
echo "============================================"

# Move to project root (two levels up from setup/mac/)
cd "$(dirname "$0")/../.."
...
# uv will auto-download Python 3.12 if not installed on the system
if [ ! -d ".venv" ]; then
...
echo "============================================"
echo " Setup complete!"
echo " Next: bash setup/mac/start.sh"
echo "============================================"
